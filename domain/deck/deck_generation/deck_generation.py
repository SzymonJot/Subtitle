from deck.schemas.schema import Card, Candidate, OutputFormat, Deck
from common.schemas import BuildDeckRequest
import hashlib

def assemble_cards(selection_with_examples: list[Candidate], req: BuildDeckRequest) -> list[Card]:
    """
...
def build_deck(req: BuildDeckRequest, stats: dict, file_bytes: bytes, format: OutputFormat, result_path: str) -> Deck:
    """
