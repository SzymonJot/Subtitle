...
class LangAdapter(ABC):
    ...
    @staticmethod
    def attach_examples(
        sentences: List[SentenceRec], lexicon: Dict[str, LemmaBase]
    ) -> Dict[str, LemmaBase]:
        """
...
if __name__ == "__main__":
    ...
    lexicon = {
        "fanny": LemmaBase(pos="NOUN", forms=["Fanny"], examples={}),
        "alexander": LemmaBase(pos="NOUN", forms=["Alexander"], examples={}),
        "andra": LemmaBase(pos="PRON", forms=["andra", "Andra"], examples={}),
        "familjeliv": LemmaBase(pos="NOUN", forms=["familjeliv"], examples={}),
    }
